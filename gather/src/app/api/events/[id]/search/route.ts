 ...
 * probe, and Stage 1 and 2 rank the result (PRD Sections 8, 10, 11). A card or a sentence that
 * names cards also lists the print shop's designs, each with its quote as the delivery window. Body:
 * { card?: string, sentence?: string, probe?: number } where probe caps how many candidates get a
 * checkout probe.
 */
